    ...
    <div id="main">
      <div id="reg">
       ...
       <div id="reg-left">
          ...
          <div id="reg-left-mid">
            <h1>LCEP</h1>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus nostrum blanditiis quidem natus dolore nihil quae!</p>
          </div>
     ...
     <div id="log-right">
          ...
          <form id="registration-form">
              ...
              <p  style="font-size: 12px ;margin-top: 4px;">I Don't have any Account <span><a href="#">Sign Up</a></span></p>
          </form>
 ...
 <div id="reg-right">
    <div id="form-container">
        ...
        <form id="registration-form" action="/lcep/register" method="post">
            ...
            <input type="number" placeholder="contact No." name="contNo" required>
           ...
           -->
            <div class="checkbox-container">
                ...
                <label for="terms" style="font-size: 10px;">I have agreed to the terms and conditions</label>
            </div>
            <button type="submit">SUBMIT</button>
            <p  style="font-size: 12px ;margin-top: 4px;">Have Already Account <span><a href="#">Log in</a></span></p>
        </form>
