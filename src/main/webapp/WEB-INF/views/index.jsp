	...
	<div id="main">
			...
			<div id="container">
				<div id="left">
					...
					<div id="bars">
							...
							<div class="barright">
								<div class="in">
									<button  type="button" class="create btn btn-primary"
										data-toggle="modal" data-target="#createEventModal" style="color: var(- -graydark);">Create
										Post</button>
													...
													<form>
														<div class="form-group">
															<label for="eventTitle">Event Title:</label> <input
																...
																placeholder="Enter event title" name="eventTitle"
																required>
														</div>
														...
														<div class="form-group">
															<label for="eventTime">Event Time:</label> <input
																...
																id="eventTime" name="eventTime" required>
														</div>
														<div class="form-group">
						...
						<div class="bar">
							<div class="barleft">
								<div class="in bar-img"></div>
							</div>
							<div class="barright">
								<div class="in">
									<h3 style="color: var(- -graydark)">Question 1</h3>
								</div>
							</div>
						</div>
						<div class="bar">
							...
							<div class="barright">
								<div class="in">
									<h3 style="color: var(- -graydark)">Question 2</h3>
								</div>
							</div>
						</div>
						<div class="bar">
							...
							<div class="barright">
								<div class="in">
									<h3 style="color: var(- -graydark)">Question 3</h3>
								</div>
							</div>
						</div>
						<div class="bar">
							...
							<div class="barright">
								<div class="in">
									<h3 style="color: var(- -graydark)">Question 4</h3>
								</div>
							</div>
						</div>
					</div>
						...
						<div id="post-upper">
							...
							<div id="post-up-right">
								<div id="post-up-right-up">
									<h3
										style="position: absolute; margin-left: 10px; margin-top: 10px; color: var(- -graydark)">
						...
						<div id="post-text">
							<div class="post-text-in">
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
									Eius sit tenetur aliquam, mollitia alias quibusdam voluptatum
									consectetur earum, obcaecati reprehenderit possimus voluptates
									modi provident incidunt assumenda quasi molestiae eos atque.
									Lorem ipsum dolor sit amet consectetur adipisicing elit.
									Eveniet, asperiores. Incidunt, minus, id facilis alias quod qui
									perferendis officiis nostrum dolorem pariatur cum. Eveniet
									officia at illo, vitae ut asperiores id nesciunt provident
									aliquid veniam doloremque quas rerum incidunt facilis eum quam
									blanditiis velit accusantium expedita ad laboriosam eaque
									praesentium!</p>
							</div>
						</div>
						<div id="post-img"></div>
		...
		<div id="create-post">
			<div class="create-post-up">
				...
				<h3
					style="position: absolute; margin-left: 20px; margin-top: 20px; color: var(- -graydark)">
					Name of The User <span><h5 style="color: rgb(69, 69, 69);">10
							April 2024</h5></span>
				</h3>
			...
			<div class="create-post-mid">
				<textarea class="create-post-input" name="" id="" cols="30"
					rows="10" placeholder=" Write your Question..."></textarea>
